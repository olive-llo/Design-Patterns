...
public class DessinerHorloge2 implements ICallbackPaint
{
	private final int LARGEUR_SECONDES = 4;
	private final int LARGEUR_MINUTES = 8;
	private final int LARGEUR_HEURES = 12;
	...
	public void paint(Graphics gsp)
	{
	    ...
	    gsp.drawString("XII",55,16);

	    gsp.drawString("VI",58,116);

	    gsp.drawString("III",108,66);

	    gsp.drawString("IX",8,66);
